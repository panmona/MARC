...
namespace MARC
{
	...
	public class FileMARCXML : IEnumerator, IEnumerable
	{
		...
		public static List<string> Validate(XDocument source)
		{
			...
			var marc21Slim =
				"..\\MARC21slim.xsd;System.String, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089;Windows-1252";
			using (StringReader reader = new StringReader(marc21Slim))
			{
